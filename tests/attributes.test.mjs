...
const source={id:'source',media:'a',kind:'video',in:1,out:8,start:2,layer:0,speed:.2,endSpeed:3,curve:'ease-in-out',timingBase:{in:0},scale:1.4,x:.2,y:.8,color:{exposure:.5},audio:{volume:.4,mute:true},opacity:.7};
