...
const workflowGroups=[...html.matchAll(/class="[^"]*workflow-group[^"]*"/g)];if(workflowGroups.length!==4)throw Error('Workflow must keep four editorial stages');
for(const label of ['素材準備','編集','仕上げ','補助','履歴','クリップ','範囲'])if(!html.includes(label))throw Error('Missing workflow label: '+label);
