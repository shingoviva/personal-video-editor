# PERSONAL VIDEO EDITOR — V1 Preview · 1.7.0
...
画面はウインドウの高さに合わせ、素材／設定／タイムラインをそれぞれスクロール。タイムラインのトラック名と縦スクロールを同期し、編集ツールは固定します。素材・設定の⤢でパネルを広げ、もう一度押すと戻ります。iPhoneはキーボード表示時の有効高さにも合わせます。
