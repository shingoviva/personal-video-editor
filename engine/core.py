...
def capabilities():
 ...
 return {'ready':ready,'complete':ready and stabilization and hdr and text,'stabilization':stabilization,'hdr':hdr,'text':text,'videotoolbox':'h264_videotoolbox' in e,'build':'1.7.2','engine':'Native FFmpeg','version':subprocess.run([FFMPEG,'-version'],capture_output=True,text=True).stdout.splitlines()[0]}
